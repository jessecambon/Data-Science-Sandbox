...
* [Creating Formatted Spreadsheets](source/Create_Formatted_Spreadsheets.md) - How to create a custom formatted spreadsheet report with the openxlsx R package.
